...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Textview in layout file
        jsonData = (TextView) findViewById(R.id.jsonResponse);
        // Network status reference
        TextView phoneIsConnected = (TextView) findViewById(R.id.phoneIsConnected);
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        //Main function for async
        @Override
        protected String doInBackground(String... urls) {//Runs when function is executed

            return GET(urls[0]);//Runs the function called GET above. If multiple,pass array
        }
        // onPostExecute displays the results of the AsyncTask.
        @Override
        protected void onPostExecute(String result) {
            Toast.makeText(getBaseContext(), "Data has been pulled!", Toast.LENGTH_LONG).show();
    ...
    public boolean isConnected(){//SIMPLY DETECTS IF THERE IS INTERNET CONNECTION
